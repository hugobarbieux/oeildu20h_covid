...
### __Repartition des doses de vaccins par 100 habitants elegibles a la vaccination__
...
map_france_prior <- tm_shape(map_publicprior_df) +
  ...
  tm_bubbles(id = "text",
             ...
             style="equal",
             title.col="Nombre de doses pour 100 habitants eligibles a la vaccination",
...
### __Chiffres cumules de livraisons, tous vaccins confondus.__
...
### __Chiffres de livraisons, __par 100 habitants__, tous vaccins confondus.__
...
map_france2 <- tm_shape(data_map2) +
  ...
  tm_credits("Source : data.gouv.fr",
             col = "grey10",
             position = c("right", "bottom")) +
  tm_layout("Doses livrées, par 100 hab.- total",
            title.size = 1.8,
            bg.color="#e6e6e6",
            legend.title.size=1.2,
            fontfamily = "Brown",
