...
sp_pos_quot_fra <- read.csv(url7, sep = ";")
```
...
## Evolution du taux d'incidence par classe d'age
...
p2 <- ggplot(dt8, aes(x = jour, y = as.character(cl_age90), fill = incid))+
  ...
  scale_fill_viridis(option = "plasma") +#(values=c("#b30000","#d7301f","#ef6548","#fc8d59","#fdbb84","#fdd49e","#fee8c8", "#fff7ec"),na.value = "grey90")+
  ...
  theme(legend.position="right",legend.direction="vertical",
        ...
        axis.text.y=element_text(size=10, vjust=0.2,colour=textcol,family = "Brown"),
        axis.ticks=element_line(size=0.4),
        plot.background=element_blank(),
        panel.border=element_blank(),
        #plot.margin=margin(0.7,0.4,0.1,0.2,"cm"),
        plot.title=element_text(colour="#444444",hjust=0,size=20,family = "Brown"),
        plot.subtitle = element_text(colour="#444444",hjust=0,size=16,family = "Brown"))
